...
def placeMarketOrderLT(symbol,buy_sell,quantity):
    # Place an intraday market order on NSE
    if buy_sell == "buy":
        t_type=kite.TRANSACTION_TYPE_BUY
    elif buy_sell == "sell":
...
# placeMarketOrderLT("INFY", "buy", 1)

def placeLimitOrderLT(symbol,buy_sell,quantity, price):
    # Place an intraday market order on NSE
    if buy_sell == "buy":
        t_type=kite.TRANSACTION_TYPE_BUY
    elif buy_sell == "sell":
